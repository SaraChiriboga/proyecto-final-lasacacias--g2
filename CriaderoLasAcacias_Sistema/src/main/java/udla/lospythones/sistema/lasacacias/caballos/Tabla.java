...
public class Tabla extends javax.swing.JFrame {
    ...
    public Tabla() {
        initComponents();
        ListadoCaballos.setModel(callabo.transferDetalles());
    }

    //metodo para imprimir infomación encontrada en base a la id de un caballo
    public void mostrarResultadoBusqueda() throws IOException {
